...
Public Class modificar_a
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If ComboBox1.SelectedIndex = -1 Then
            MsgBox("Seleccione el alumno a modificar")
        ElseIf direccion.Text.Length = 0 Then
            MsgBox("Ingrese la nueva direccion ")
        ElseIf alergia.Text.Length = 0 Then
            MsgBox("ingrese la alergia")
        ElseIf telefono.Text.Length = 0 Then
        ...
        ElseIf ComboBox2.SelectedIndex = -1 Then
            ...
            mycommand.CommandText = "UPDATE alumno SET direccion = @direccion,tipo_alergia = @tipo_alergia,telefono = @telefono, estado = @estado Where rut = @rut"
            myconnect.Open()
    ...
    Private Sub modificar_a_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
